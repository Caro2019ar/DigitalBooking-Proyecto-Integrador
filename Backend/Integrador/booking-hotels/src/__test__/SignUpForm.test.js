...
describe('<SignUpForm />', () => {
    ...
    it('Dentro del form existe un input de tipo "text" que tiene un label asociado con el texto "Nombre"', () => {
        ...
        expect(within(view.getByRole('form')).queryByLabelText("Nombre")).toBeInTheDocument();
        expect(within(view.getByRole('form')).getByLabelText("Nombre")).toHaveAttribute('type', 'text');
    });

    it('Dentro del form existe un input de tipo "text" que tiene un label asociado con el texto "Apellido"', () => {
        const view = render(<MemoryRouter> <SignUpForm /> </MemoryRouter>);
        // El ByLabelText devuelve un INPUT
        expect(within(view.getByRole('form')).queryByLabelText("Apellido")).toBeInTheDocument();
        expect(within(view.getByRole('form')).getByLabelText("Apellido")).toHaveAttribute('type', 'text');
    });
    ...
    it('Dentro del form existe un input de tipo "password" que tiene un label asociado con el texto "Confirmar contraseña"', () => {
        const view = render(<MemoryRouter> <SignUpForm /> </MemoryRouter>);
        // El ByLabelText devuelve un INPUT
        expect(within(view.getByRole('form')).queryByLabelText("Confirmar contraseña")).toBeInTheDocument();
        expect(within(view.getByRole('form')).getByLabelText("Confirmar contraseña")).toHaveAttribute('type', 'password');
    });
    ...
    it('Dentro del form existe un botón con el texto "Crear Cuenta" y está habilitado', () => {
        ...
        expect(within(view.getByRole('form')).getByRole("button")).toHaveTextContent("Crear Cuenta");
    ...
    it('El form renderiza los datos que se ingresan en los input', () => {
        ...
        userEvent.type(view.getByLabelText("Correo electrónico"), 'email-ingresado');
        userEvent.type(view.getByLabelText("Contraseña"), 'password-ingresado');
        userEvent.type(view.getByLabelText("Confirmar contraseña"), 'password-repetido-ingresado');
    ...
    it('El form muestra mensajes de error si se intenta crear una cuenta con los input vacíos', () => {
        ...
        expect(within(view.getByRole('form')).getAllByText("Este campo es obligatorio")).toHaveLength(5);
    });
    ...
    it('El form muestra un mensaje de error cuando el nombre es menor a 3 caracteres', () => {
        ...
        userEvent.click(view.getByRole('button'));
        expect(within(view.getByRole('form')).queryByText("El nombre es muy corto, debe tener al menos 3 caracteres")).toBeInTheDocument();
    });
    ...
    it('El form muestra un mensaje de error cuando el apellido es menor a 3 caracteres', () => {
        ...
        userEvent.click(view.getByRole('button'));
        expect(within(view.getByRole('form')).queryByText("El apellido es muy corto, debe tener al menos 3 caracteres")).toBeInTheDocument();
    });
    ...
    it('El form muestra un mensaje de error cuando el correo electrónico ingresao no es válido', () => {
        ...
        userEvent.click(view.getByRole('button'));
        expect(within(view.getByRole('form')).queryByText("El email ingresado no es válido")).toBeInTheDocument();
    });
    ...
    it('El form muestra un mensaje de error cuando las contraseñas no coinciden', () => {
        ...
        userEvent.click(view.getByRole('button'));
        expect(within(view.getByRole('form')).queryByText("Las contraseñas ingresadas no coinciden")).toBeInTheDocument();
    });
    ...
    it('El mensaje de error del Nombre desaparece al escribir en su correspondiente input', () => {
        ...
        expect(within(inputNombre.parentElement).queryByText("Este campo es obligatorio")).not.toBeNull();
        userEvent.type(inputNombre, 'a');
        expect(within(inputNombre.parentElement).queryByText("Este campo es obligatorio")).toBeNull();
    });
    ...
    it('El mensaje de error del Apellido desaparece al escribir en su correspondiente input', () => {
        ...
        expect(within(inputApellido.parentElement).queryByText("Este campo es obligatorio")).not.toBeNull();
        userEvent.type(inputApellido, 'a');
        expect(within(inputApellido.parentElement).queryByText("Este campo es obligatorio")).toBeNull();
    });
    ...
    it('El mensaje de error de "Confirmar contraseña" desaparece al escribir en su correspondiente input', () => {
        ...
        expect(within(inputPasswordRepeat.parentElement).queryByText("Este campo es obligatorio")).not.toBeNull();
        userEvent.type(inputPasswordRepeat, 'a');
        expect(within(inputPasswordRepeat.parentElement).queryByText("Este campo es obligatorio")).toBeNull();
    });
